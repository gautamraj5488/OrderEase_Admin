...
class MobileCouponsPage extends StatefulWidget {
  final String shopId;

  const MobileCouponsPage({Key? key, required this.shopId}) : super(key: key);

  @override
  State<MobileCouponsPage> createState() => _TabCouponsPageState();
}

class _TabCouponsPageState extends State<MobileCouponsPage> {
